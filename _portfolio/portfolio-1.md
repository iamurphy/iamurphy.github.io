...
$$
y_i = \beta_0 + \beta_1 x_i + \beta_2 \texttt{Type}_i + \beta_3 \texttt{Method}_i + \beta_4 \texttt{Time}_i + \beta_5 \texttt{Temperature}_i + \texttt{Interactions}_i + \epsilon_i
$$
...
$$
Y_2 = -0.023 + 1.014 \texttt{before} + 0.301 I(Type = Shiitake) - 0.044 I(Method = Soak) + 0.246
$$
...
$$
Y_3 = -0.023 + 1.014 \texttt{before} + 0.301 I(Type = Shiitake) - 0.044 I(Method = Soak) + 0.297
$$
