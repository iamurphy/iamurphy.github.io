...
$$\begin{align*}y_i = \beta_0 &+ \beta_1 x_i + \beta_2 \texttt{Type}_i + \beta_3 \texttt{Method}_i + \beta_4 \texttt{Time}_i + \beta_5 \texttt{Temperature}_i \\ &+ \texttt{Interactions}_i + \epsilon_i\end{align*}$$
